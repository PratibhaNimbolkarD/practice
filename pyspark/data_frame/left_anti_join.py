...
spark = SparkSession.builder.appName('left_anti_join').getOrCreate()
...
df_join = employee_df.join(department_df , employee_df.employee_dept_id == department_df.dept_id , "anti")
employee_df.show()
department_df.show()
df_join.show()
